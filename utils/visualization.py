...
Functions to plot audio waveforms, spectrograms, frequency spectra and comparisons using matplotlib and Streamlit.
"""
...
def plot_comparison(original_data, processed_data, sample_rate, effect_name):
    ...
    with col1:
        plot_audio_waveform(original_data, sample_rate, f'Original Waveform – {effect_name}')

    with col2:
        plot_audio_waveform(processed_data, sample_rate, f'Processed Waveform – {effect_name}')


def plot_spectrogram_comparison(original_data, processed_data, sample_rate, effect_name):
    """
    ...
    with col1:
        plot_spectrogram(original_data, sample_rate, f'Original Spectrogram – {effect_name}')

    with col2:
        plot_spectrogram(processed_data, sample_rate, f'Processed Spectrogram – {effect_name}')


def plot_frequency_spectrum_comparison(original_data, processed_data, sample_rate, effect_name):
    """
    ...
    with col1:
        plot_frequency_spectrum(original_data, sample_rate, f'Original Frequency Spectrum – {effect_name}')

    with col2:
        plot_frequency_spectrum(processed_data, sample_rate, f'Processed Frequency Spectrum – {effect_name}')


def plot_comprehensive_comparison(original_data, processed_data, sample_rate, transformation_name):
    """
    Plot comprehensive comparison including waveforms, spectrograms and frequency spectra.
    ...
    plot_comparison(original_data, processed_data, sample_rate, transformation_name)
    
    # Frequency spectrum comparison
    st.subheader("Frequency Spectrum Comparison")
    plot_frequency_spectrum_comparison(original_data, processed_data, sample_rate, transformation_name)
    
    # Spectrogram comparison
    st.subheader("Spectrogram Comparison")
    plot_spectrogram_comparison(original_data, processed_data, sample_rate, transformation_name)
